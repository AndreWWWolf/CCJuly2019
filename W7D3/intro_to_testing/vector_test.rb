...
# It means testing a minimal piece of code isolated from the rest
# of application.
...
# For a web application, this might mean simulating a browser with a headless
# Chrome browser or Selenium.
